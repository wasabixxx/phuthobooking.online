<?php
session_start(); // Đảm bảo dòng này ở đầu tệp nếu chưa có trong config/database.php

include('config/database.php');
$db = new Database();

// Kiểm tra phiên trước khi có bất kỳ đầu ra nào
if (!isset($_SESSION['name'])) {
    header('Location: login.php');
    exit();
}

// Sau đó mới bao gồm các tệp giao diện
