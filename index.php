...
<section class="customer top" id="testimonials">
    <div class="container">
        ...
        <div class="owl-carousel owl-theme mtop">
            <div class="item">
                <p>"test gitfsdfs"Với vai trò là chủ nhiệm đề tài của nền tảng đặt phòng khách sạn tỉnh Phú Thọ, tôi xin gửi lời tri ân
            ...
            <div class="item">
                ...
                <div class="admin flex">
                    ...
                    <div class="text">
                        <h3>Nguyễn Tùng Dương</h3>
                        <span>Tester | UI designer | FE Dev | Cười mồi + vỗ tay</span>
                    </div>
                </div>
            </div>
